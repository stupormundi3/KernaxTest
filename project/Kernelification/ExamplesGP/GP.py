...
from Kernax import RBFKernel as RBF
from Kernax import AbstractKernel as Kernel
from Kernax import ConstantKernel as C
...
class GaussianProcessRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    * exposes a method `log_marginal_likelihood(theta)`, which can be used
    ...
    def fit(self, X, y):
        #Need to wrap this function into a new one, and each instance of self object need to be considered
        #In the args, like self.kernel, self.rng etc 
        #So fit(kernel, rng, random_state)
